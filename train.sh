...
python -m EasyLM.models.llama.llama_train \
    ...
    --train_dataset.json_dataset.path='./example_data/train_examples.json' \
    --train_dataset.json_dataset.seq_length=256 \
    ...
    --logger.output_dir="./experiments/your_run_id/checkpoints" \
    --logger.wandb_dir="./experiments/your_run_id/logs" \
|& tee $HOME/output.txt
